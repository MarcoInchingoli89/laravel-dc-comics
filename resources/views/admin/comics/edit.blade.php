    ...
    <form action="{{ route('comics.update', $comic->id) }}" method="post">
        ...
        <div>
            ...
            <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror"
                placeholder="Scrivi qui il titolo" aria-describedby="titleHlper" required
        ...
        <div>
            ...
            <input type="text" name="thumb" id="thumb" class="form-control @error('thumb') is-invalid @enderror"
                placeholder="Aggiungi qui l'immagine" aria-describedby="titleHlper"
        ...
        <div>
            ...
            <input type="text" name="description" id="description"
                ...
                aria-describedby="titleHlper" value="{{ old('description', $comic->description) }}">
        </div>
        <div>
            <label for="price" class="form-label">Price</label>
            <input type="text" name="price" id="price" class="form-control @error('price') is-invalid @enderror"
                placeholder="Scrivi qui il prezzo" aria-describedby="titleHlper" value="{{ old('price', $comic->price) }}">
        </div>
        <div>
            <label for="series" class="form-label">Series</label>
            <input type="text" name="series" id="series" class="form-control @error('series') is-invalid @enderror"
                placeholder="Scrivi qui la serie" aria-describedby="titleHlper" value="{{ old('series', $comic->series) }}">
        </div>
        <div>
            ...
            <input type="text" name="sale_data" id="sale_data"
                ...
                aria-describedby="titleHlper" value="{{ old('sale_data', $comic->sale_data) }}">
        </div>
        <div>
            <label for="type" class="form-label">Type</label>
            <input type="text" name="type" id="type" class="form-control @error('type') is-invalid @enderror"
                placeholder="Scrivi qui il tipo" aria-describedby="titleHlper" value="{{ old('type', $comic->type) }}">
        </div>
